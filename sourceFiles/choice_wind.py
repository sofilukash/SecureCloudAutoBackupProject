...
class Ui_choice_wind(object):
    ...
    def retranslateUi(self, choice_wind):
        ...
        self.textBrowser.setHtml(_translate('choice_wind', '<html><body><p align="center">'
                                                           'Оберіть дію</p></body></html>'))
        self.textBrowser_2.setHtml(_translate('choice_wind', '<html><body><p align="right">'
